...
late String locationinitialStation;
late LatLng initialStationlocation;

void initialStationloc(x){
  initialStationlocation = x;
}
get initialStationlocreturn{
  return initialStationlocation;
}
